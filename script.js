...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
    "9jamal, red, ayori, owa, onse, nella, andrea, jaybee, shout out all dior,",
    "\"alway reckless, lahat walang tali\""
  ];
  let bioText = '';
  let bioIndex = 0;
  ...
  homeButton.addEventListener('click', () => {
    switchTheme('suckmydick.mp4', backgroundMusic, 'home-theme');
  });
  ...
  hackerButton.addEventListener('click', () => {
    switchTheme('Go Getta - O $IDE MAFIA (Prod.by Aasis Beats).mp4', hackerMusic, 'hacker-theme', hackerOverlay, false);
  });
  ...
  rainButton.addEventListener('click', () => {
    switchTheme('O SIDE MAFIA X BRGR - GET LOW  (OFFICIAL MUSIC VIDEO).mp4', rainMusic, 'rain-theme', snowOverlay, true);
  });
  ...
  animeButton.addEventListener('click', () => {
    switchTheme('Lil Mabu x DD Osama - EVIL EMPIRE (Official Video).mp4', animeMusic, 'anime-theme');
  });
  ...
  carButton.addEventListener('click', () => {
    switchTheme('DD Osama x Notti Osama - Without You (Shot by KLO Vizionz) (Prod by Elvis Beatz).mp4', carMusic, 'car-theme');
  });
